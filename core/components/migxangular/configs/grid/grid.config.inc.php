...
$phpthumb = "[[+_config.connectors_url]]system/phpthumb.php?h=80&src='+val+source+'";
$phpthumbimg = '<img src="'.$phpthumb.'" alt="" />';
$scope = '$scope';

$renderer['this.renderImage'] = "
    {$scope}.renderImage[[+tv.fieldname]] = function(val, item, col){
        var pathconfigs = [[+pathconfigs]];
        var source = pathconfigs[col];
        if (val !== null) {
