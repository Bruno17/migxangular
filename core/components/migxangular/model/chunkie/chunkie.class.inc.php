...
if (!class_exists('migxangularChunkie')) {

    class migxangularChunkie {
        ...
        /**
         * migxangularChunkie constructor
         *
         * @param string $template Name of MODX chunk
         * @param string $basepath Basepath @FILE is prefixed with.
         */
        public function migxangularChunkie($template = '', $basepath = '', $addCore = true) {
            global $modx;
